    ...
    <div className="p-6">
        <div className="mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
              <h2 className="text-lg font-semibold text-foreground">{t('SUB-TITLE')}</h2>
              <p className="text-sm text-muted-foreground">{t('DESCRIPTION-SUBTITLE')}</p>
            </div>
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
              <SheetTrigger asChild>
                <Button className="w-full sm:w-auto" onClick={() => setSelectedUser(null)}>
                  <Plus className="w-4 h-4 mr-2" />
                  {t("NEW-USER")}
                </Button>
              </SheetTrigger>
              <SheetContent className="w-full sm:max-w-lg lg:max-w-xl p-0">
                <UserForm
